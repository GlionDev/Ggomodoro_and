        ...
        bottomBar = {
            NavigationBar(
                ...
                NavigationBarItem(
                    ...
                    icon = { Icon(painter = painterResource(android.R.drawable.ic_menu_recent_history), contentDescription = "Timer") },
                    label = { Text("Timer") },
                    colors = NavigationBarItemDefaults.colors(
                        selectedTextColor = MaterialTheme.colorScheme.onPrimaryContainer, // Black
                        selectedIconColor = MaterialTheme.colorScheme.onPrimaryContainer, // Black
                        indicatorColor = MaterialTheme.colorScheme.primaryContainer, // Pastel Yellow
                ...
                NavigationBarItem(
                    ...
                    icon = { Icon(painter = painterResource(android.R.drawable.ic_menu_save), contentDescription = "History") },
                    label = { Text("History") },
                    colors = NavigationBarItemDefaults.colors(
                        selectedIconColor = MaterialTheme.colorScheme.onPrimaryContainer, // Black
                        selectedTextColor = MaterialTheme.colorScheme.onPrimaryContainer, // Black
